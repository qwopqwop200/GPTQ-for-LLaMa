...
qlayer = QuantLinear(2, -1, layer.in_features, layer.out_features, bias =True,kernel_switch_threshold = False)
...
qlayer = QuantLinear(3, -1, layer.in_features, layer.out_features, bias =True, kernel_switch_threshold = False)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
...
qlayer = QuantLinear(4, -1, layer.in_features, layer.out_features, bias =True, kernel_switch_threshold = False)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
...
qlayer = QuantLinear(8, -1, layer.in_features, layer.out_features, bias =True, kernel_switch_threshold = False)
qlayer.pack(layer, quantizer.scale, quantizer.zero)
