...
* Changed to use an optimized kernel that uses [triton](https://github.com/openai/triton).
* Changed the code to support backward.
...
CUDA_VISIBLE_DEVICES=7 python llama.py /llama/7B-huggingface c4 --wbits 4 --true-sequential --act-order --groupsize 128 --save llama7b-4bit-128g.pt
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4 python llama.py /llama/7B-huggingface-v4.28.0.dev/ c4 --benchmark 2048 --check

# model inference with the saved model
CUDA_VISIBLE_DEVICES=7 python llama_inference.py /llama/7B-huggingface-v4.28.0.dev/ --wbits 4 --groupsize 128 --load llama7b-4bit-128g.pt --text "this is llama"

CUDA_VISIBLE_DEVICES=7 python llama_inference.py /llama/7B-huggingface-v4.28.0.dev/ --wbits 4 --groupsize -1  --load llama7b-4bit-128g.pt --text "this is llama"
